...
{
    [TestClass]
    public class NewsTestUpdate : BaseTest
    {
        #region Objects
        ...
        #region Update_News_Should_Return_Ok
        [TestMethod]
        public async Task Update_News_Should_Return_Ok()
        {
            //Arrange
            Cleanup();
            MakeArrange();
            ...
            //Act
            var response = await _newsController.UpdatePutAsync(id, newsUpdateDTO);
        ...
        #region Update_News_Should_Return_Bad_Request
        [TestMethod]
        public async Task Update_News_Should_Return_Bad_Request_Id_Equals()
        {
            //Arrange
            Cleanup();
            MakeArrange();
        ...
        #region Update_News_Should_Return_Bad_Request_Image_Is_Required
        [TestMethod]
        public void Update_News_Should_Return_Bad_Request_Image_Is_Required()
        {
            //Arrange
            Cleanup();
            MakeArrange();
        ...
        #region Update_News_Should_Return_Bad_Request_Name_Is_Required
        [TestMethod]
        public void Update_News_Should_Return_Bad_Request_Name_Is_Required()
        {
            //Arrange
            Cleanup();
            MakeArrange();
        ...
        #region Update_News_Should_Return_Bad_Request_Content_Is_Required
        [TestMethod]
        public void Update_News_Should_Return_Bad_Request_Content_Is_Required()
        {
            //Arrange
            Cleanup();
            MakeArrange();
        ...
        #region Update_User_Unauthorized
        [TestMethod]
        public async Task Update_User_Unauthorized()
        {
            //Arrange
            Cleanup();
            MakeArrange();
